...
$guildcmsEngineeringPublications = [
    ...
    ['id' => 'GCMS-ENG-012', 'publication' => 'Publication 12', 'volume' => 'Volume XII', 'title' => 'Installer Testing & Certification Framework', 'status' => 'Published', 'version' => '1.1', 'phase' => '4.4.0-9', 'url' => $guildcmsEngineeringPublicationsBaseUrl . 'installer-testing-certification.php'],
    ['id' => 'GCMS-ENG-013', 'publication' => 'Publication 13', 'volume' => 'Volume XIII', 'title' => 'Development & Release Standard', 'status' => 'Published', 'version' => '1.0', 'phase' => '4.4.0-9', 'url' => $guildcmsEngineeringPublicationsBaseUrl . 'development-release-standard.php'],
    ['id' => 'GCMS-CERT-001', 'publication' => 'Certification Milestone 1', 'volume' => 'Foundation Platforms', 'title' => 'Installer Certification Milestone 1', 'status' => 'Published', 'version' => '1.0', 'phase' => '4.4.0-9', 'url' => $guildcmsEngineeringPublicationsBaseUrl . 'installer-certification-milestone-1.php'],
];
