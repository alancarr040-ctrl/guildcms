...
<div class="container-fluid py-3 devcenter-admin">
    ...
    <?php elseif ($tab === 'engineering_library'): ?>
        <div class="card bg-dark border-info text-light mb-3">
            <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                <strong>Guild CMS Engineering Publications</strong>
                    <div class="small text-success mt-1">GCMS-ENG-000 through GCMS-ENG-010 are published. Volume I is complete.</div>
        ...
        <div class="card bg-dark border-success text-light mb-3">
            ...
            <div class="card-body">
                <p class="mb-3">Volume I of the Guild CMS Engineering Library has been reviewed as a complete foundational publication set. The Development Center records the publication metadata and links to the public Guild CMS site as the authoritative source for each document.</p>
                <div class="row g-3">
