...
function guildcms_engineering_publications(): array
{
    return [
        ...
        [
            ...
            'phase' => '4.4.0-9',
            'updated' => 'July 2026',
            'applies_to' => 'Guild CMS Phase 4.4 installer development and future installer releases',
            'category' => 'Installation',
            'summary' => 'Defines how Guild CMS validates installer behavior, certification environments, diagnostic checks, recovery expectations, and platform certification evidence.',
            'topics' => ['Installer certification', 'Platform validation', 'Diagnostic testing', 'Certification reports', 'Release evidence'],
        ],
        [
            'id' => 'GCMS-ENG-013',
            'publication' => 'Publication 13',
            'volume' => 'Volume XIII',
            'title' => 'Development & Release Standard',
            'slug' => 'development-release-standard.php',
            'status' => 'Published',
            'version' => '1.0',
            'phase' => '4.4.0-9',
            'updated' => 'July 2026',
            'applies_to' => 'All Guild CMS development packages and release deliveries',
            'category' => 'Governance',
            'summary' => 'Defines the official Guild CMS package workflow, repository layout, release documentation requirements, SQL migration expectations, validation gates, and Git baseline policy.',
            'topics' => ['Package layout', 'Release documentation', 'SQL migrations', 'Validation gates', 'Git baseline'],
        ],
        [
            'id' => 'GCMS-CERT-001',
            'publication' => 'Certification Milestone 1',
            'volume' => 'Foundation Platforms',
            'title' => 'Installer Certification Milestone 1',
            'slug' => 'installer-certification-milestone-1.php',
            'status' => 'Published',
            'version' => '1.0',
            'phase' => '4.4.0-9',
            'updated' => 'July 2026',
            'applies_to' => 'Guild CMS Installer 4.4.0-8a and Phase 4.4 certification records',
            'category' => 'Certification',
            'summary' => 'Publishes the first installer certification milestone covering Rocky Linux, AlmaLinux, Ubuntu, Debian, and Virtualmin deployment scenarios.',
            'topics' => ['Foundation platforms', 'Cross-platform certification', 'RHEL family', 'Debian family', 'Virtualmin'],
        ],
        [
            'id' => 'GCMS-ENG-011',
