...
$roadmap_rows = [
    ...
    ['phase' => 'Phase 4.4', 'status' => 'In Progress', 'class' => 'bg-info', 'title' => 'Installation & Bootstrap System', 'summary' => 'Builds the complete installer lifecycle, including configuration generation, requirements validation, database bootstrap, database initialization, administrator account creation, first-run site configuration, plugin manifest format, plugin discovery, hook/event system, and site bootstrap.'],
